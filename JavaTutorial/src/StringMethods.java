...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println("Check contents are equal: " + str1.contentEquals(str2));
		System.out.println("Check contents are equal: " + str1.contentEquals(str3));
		...
		System.out.println("Trime the leading and trailing spaces: " + str5.trim());
